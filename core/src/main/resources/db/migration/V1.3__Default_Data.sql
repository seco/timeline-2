...
-- 11번가
insert ignore into timeline_site(site_type, site_name, site_url, update_at, create_at) VALUES ('JOB', 'ElevenStJob', 'https://careers.11stcorp.com/jobs/list?announcement.title=&announcement.localYN=&announcement.pageIndex=0&isIng=true&announcement.pageSize=100', 1560065629, 1560065629);
